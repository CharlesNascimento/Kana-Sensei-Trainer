	...
	private void backpropagation() {
		...
		do {
			...
			if ((epochs % 10) == 0 && mProgressListener != null) {
				trainingProgress = (int) (((float) epochs / (float) mMaxEpochs) * 100 * progressCorrection);
				mProgressListener.onTrainingProgressChanged(trainingProgress, epochs, meanSquaredErrorMean);
			}
