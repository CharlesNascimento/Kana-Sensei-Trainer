...
/**
 * This class represents the output layer of a multilayer perceptron neural network.
 */
public class OutputLayer extends Layer {
    ...
    public double getMeanSquaredError() {
        ...
        for (Neuron n : this.getNeurons()) {
            ...
            mse += Math.pow(diff, 2);
            //System.out.println("expected: " + n.getExpectedOutput() + ", output: " + n.getOutput() + ", mse: " + mse);
        }
        mse = 0.5 * mse;
    ...
    /**
     * Returns a string with the factional outputs of all neurons of this layer.
     *
     * @return A string with the factional outputs of all neurons of this layer.
     */
    public String getFractionalOutput() {
